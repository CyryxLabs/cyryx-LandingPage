  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="cx-reveal grid gap-8 lg:grid-cols-[0.82fr_1.18fr] lg:items-end lg:gap-20">
          <div>
        ...
        <ol className="cx-stagger mt-14 grid gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 sm:mt-16 lg:grid-cols-3">
          {ARTIFACTS.map(([n, title, body]) => (
            <li key={n} className="cx-stagger-item bg-[var(--obsidian)] p-7 sm:p-8 lg:min-h-64">
              <span className="font-mono text-[9px] tracking-[0.22em] text-[var(--accent-glow)]">
                {n}
              </span>
              <h3 className="mt-12 font-display text-2xl font-medium tracking-[-0.03em] text-[var(--silver)]">
                {title}
              </h3>
