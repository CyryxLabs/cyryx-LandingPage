  ...
  return (
    <a
      ...
      onClick={() => {
        ...
        trackCta({ cta, section: "lyra", href: EARLY_ACCESS_HREF });
      }}
      className={
        className ??
          ...
          <div className="mx-auto max-w-4xl px-5 text-center sm:px-8">
            <div className="cx-reveal flex flex-col items-center">
              ...
              <img
                ...
                fetchPriority="high"
                decoding="async"
                className="mt-10 h-auto w-[180px] mix-blend-screen sm:w-[220px] lg:w-[260px] drop-shadow-[0_0_45px_rgba(13,148,136,0.25)]"
              />
