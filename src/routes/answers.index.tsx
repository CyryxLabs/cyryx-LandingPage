...
const ANSWERS = [
  {
    ...
    blurb: "AI execution where every action passes through policy gates, evaluators, and human review — instead of free-running generation.",
  },
  {
    slug: "ai-execution-system-vs-ai-automation",
    title: "AI execution system vs AI automation",
    blurb: "Automation runs scripts. Execution systems run goals, evaluate outputs against intent, and gate downstream actions.",
  },
  {
    slug: "what-are-command-gates-in-ai-systems",
    title: "What are command gates in AI systems?",
    blurb: "Policy and evaluation checkpoints between an agent's output and any downstream action. The unit of governance in agentic systems.",
  },
  {
    slug: "what-is-goal-grounded-generation",
    title: "What is goal-grounded generation?",
    blurb: "Generation conditioned on an explicit mission, context graph, and acceptance criteria — not just a prompt.",
  },
  {
    slug: "how-to-measure-ai-output-quality",
    title: "How to measure AI output quality",
    blurb: "Structural checks, task-level evaluators, regression suites, and targeted human review — combined into a single quality signal.",
  },
];
  ...
  return (
    <div className="dark min-h-dvh bg-[var(--onyx)] text-[var(--silver)]">
      ...
      <main className="mx-auto max-w-4xl px-5 sm:px-8 lg:px-12 pt-32 pb-24 lg:pt-44">
        <HudLabel withDot className="text-[var(--accent-glow)]">Cyryx Answers</HudLabel>
        ...
        <p className="mt-6 max-w-2xl text-base lg:text-lg leading-relaxed text-[var(--silver-dim)]">
          Cyryx Labs publishes precise, citation-ready explainers for the concepts behind our products, runtime, and research. Each page leads with a direct answer, then defines the concept, shows how it works, and links to related ideas.
        </p>
            ...
            <li key={a.slug}>
              ...
              >
                ...
                <span className="mt-3 inline-flex items-center gap-1 text-xs text-[var(--accent-glow)]">
                  Read answer <ArrowRight className="h-3.5 w-3.5 transition-transform group-hover:translate-x-0.5" />
                </span>
              </a>
            </li>
          ))}
