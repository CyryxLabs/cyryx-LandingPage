    ...
    <div className="dark min-h-dvh bg-[var(--onyx)] text-[var(--silver)]">
      ...
      <main className="mx-auto max-w-3xl px-5 sm:px-8 lg:px-12 pt-32 pb-24 lg:pt-44">
        ...
        <Sec heading="What MAAX Studio is">
          <p>
            A local-first agentic software execution environment for AI-native builders. It is a key component of <strong className="text-[var(--silver)]">Operational AI</strong>.
          </p>
        </Sec>
