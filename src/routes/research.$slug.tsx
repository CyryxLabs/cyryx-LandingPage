      ...
      <main id="main-content" tabIndex={-1} className="outline-none">
        <section className="relative overflow-hidden border-b border-white/10 px-5 pb-20 pt-32 sm:px-8 lg:pb-28 lg:pt-44">
          ...
          <div className="relative mx-auto max-w-7xl">
            <Link
              to="/research"
              className="inline-flex min-h-11 items-center gap-2 font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--silver-dim)] transition hover:text-[var(--accent-glow)]"
            >
              ...
              <dl className="grid grid-cols-2 gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10">
                {[
                  ...
                  <div key={label} className="bg-[var(--obsidian)] p-5">
                    <dt className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--steel)]">
                      {label}
                    </dt>
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              {publication.doiUrl && recordVerified && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md bg-[var(--silver)] px-6 font-mono text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--onyx)] transition hover:bg-white"
                >
              ...
              {publication.sourceUrl && recordVerified && (
                <a
                  ...
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-white/15 px-6 font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--silver)] transition hover:border-[var(--accent-glow)] hover:text-[var(--accent-glow)]"
                >
        ...
        <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
          <div className="grid gap-12 lg:grid-cols-[0.34fr_0.66fr] lg:gap-24">
            <div>
              ...
              <p className="mt-6 font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--steel)]">
            ...
            <div className="space-y-6 text-base leading-relaxed text-[var(--silver-dim)] sm:text-lg">
              ...
              <div className="flex flex-wrap gap-2 pt-3">
                {publication.keywords.map((keyword) => (
                  <span
                    key={keyword}
                    className="rounded-full border border-white/10 px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--steel)]"
                  >
                    {keyword}
                  </span>
                ))}
              ...
              <div className="mt-12 grid gap-px overflow-hidden rounded-lg border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
                {publication.controlDomains.map((domain) => (
                  <article key={domain.id} className="min-h-48 bg-[var(--graphite)] p-6">
                    ...
                    <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.15em] text-[var(--steel)]">
          ...
          <section className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28 lg:px-10">
            ...
            <div className="mt-10 max-w-full overflow-x-auto rounded-lg border border-white/10">
              <table className="w-full border-collapse text-left" style={{ minWidth: 840 }}>
                <thead className="bg-[var(--graphite)] font-mono text-[11px] uppercase tracking-[0.14em] text-[var(--steel)]">
                  <tr>
          ...
          <div className="grid min-w-0 gap-10 rounded-xl border border-white/10 bg-[var(--obsidian)] p-7 sm:p-10 lg:grid-cols-[0.45fr_0.55fr] lg:gap-16">
            ...
            <div className="min-w-0">
              ...
              <button
                ...
                className="mt-4 inline-flex min-h-11 items-center gap-2 rounded-md border border-white/15 px-5 font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--silver)] transition hover:border-[var(--accent-glow)] hover:text-[var(--accent-glow)]"
              >
                {copied ? (
...
function RecordRow({ label, value, href }: { label: string; value?: string; href?: string }) {
  ...
  return (
    <div className="grid min-w-0 grid-cols-1 gap-2 border-t border-white/10 pt-4 sm:grid-cols-[7rem_minmax(0,1fr)] sm:gap-4">
      <dt className="font-mono text-[11px] uppercase tracking-[0.16em] text-[var(--steel)]">
        {label}
      </dt>
